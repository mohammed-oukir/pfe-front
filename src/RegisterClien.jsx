...
import './RegisterClient.css'; // Assurez-vous que le chemin est correct
            ...
            <div className="content">
                <form onSubmit={handleSubmit}>
                    <div className="user-details">
                        {['fullName', 'username', 'email', 'phoneNumber', 'password'].map((item, index) => (
                            <div className="input-box" key={index}>
                                <span className="details">{item.split(/(?=[A-Z])/).join(" ")}</span>
                                <input
